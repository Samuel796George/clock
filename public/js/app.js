...
DayNight.addEventListener("click" , function () {
    ...
    let teh = document.getElementById("Lagos");
...
if(Day == 1){
    Dtext.innerHTML= 'Today is Moday';
}
else if(Day == 2){
    Dtext.innerHTML= 'Today is Tuesday';
}
else if(Day == 3){
    Dtext.innerHTML= 'Today is Wednesday';
}
else if(Day == 4){
    Dtext.innerHTML= 'Today is Thursday';
}
else if(Day == 4){
    Dtext.innerHTML= 'Today isFriday';
}
else if(Day == 4){
    Dtext.innerHTML= 'Today is Saturday';
}
